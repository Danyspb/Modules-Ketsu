    ...
    const DefaultLayouts = {
        ...
        for (d of dtas){
            var status = 'Status: '+d.querySelector('.status.Completed').textContent;
            ...
            let donnes = new Data(image, title, status, chapitre, type, '', '', false, link);
            sorties.push(donnes);
        }
        var testLayout = new Layout(new Insets(10, 10, 10, 10), 1, 2, 3, 1, 500, new Size(400, 400), new Ratio('width', 4, 11), new Size(0, 0), 10, 10);
        output.push(new Output(CellDesings.wide11, Orientation.vertical, DefaultLayouts.none, Paging.none, new Section('', false), testLayout, sorties));
