...
let chap = 'Chapter: '+t.querySelector('.media-body span a ').textContent.replace('#','').trim();
sortie3.push(new Data(image, title, '',chap,'','','',false,link));
}

output.push(new Output(CellDesings.normal1, Orientation.vertical, DefaultLayouts.longTripletsDouble, Paging.leading, new Section('Latest Manga :', true), null, sortie3));
