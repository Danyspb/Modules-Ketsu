...
const DefaultLayouts = {
   ...
   for ( i = 0; i < rec.length; i++) {
      ...
      for (don of dat){
          ...
          var eps ='eps:'+ don.querySelector('tr:nth-child(3) td:nth-child(2) headline2 center font font').textContent.trim();
          ...
          donnes.push(new Data(image, title, '',eps,type,'','',false,link));

      }       
   }
   output.push(new Output(CellDesings.normal1, Orientation.horizontal, DefaultLayouts.longTripletsDouble, Paging.leading, new Section('Anime Aléatoire: ', true), null, donnes));
   let MainPageObject = new MainPage(new ModuleRequest('https://www.ianimes.org/index.php','get',emptyKeyValue,null),new Extra([new Commands('',emptyKeyValue)],emptyKeyValue),new JavascriptConfig(true,false,''),output);
