  ...
  for (c of check) {
      ...
      link = new ModuleRequest(link, 'get', emptyKeyValue, null);
      var image = c.querySelector('.item-thumb.c-image-hover a img').src.replace('-193x278','');
      image = new ModuleRequest(image, 'get', emptyKeyValue, null);
  ...
  for (av of avoir) {
      ...
      var image = av.querySelector('.popular-img.widget-thumbnail.c-image-hover a img').src.replace('-75x106', '');
      image = new ModuleRequest(image, 'get', emptyKeyValue, null);
