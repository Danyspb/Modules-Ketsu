...
var check = document.querySelectorAll('.moviefilm');
for (c of check){
var link = c.querySelector('a').href;
link = new ModuleRequest(link, 'get', emptyKeyValue, null);
var image = c.querySelector('a > img').src;
image = new ModuleRequest(image, 'get', emptyKeyValue, null);
var title = c.querySelector('a > img').alt;
recherche.push(new Data(image, '', '',title,'Drama','unknow','unknow',false, link));
}
